      ...
      <div className="flex flex-col-reverse md:flex-row gap-10 items-center">
        ...
        <div className="md:w-2/3 space-y-1 text-lg md:text-xl  ">
          ...
          <p className="text-justify leading-relaxed ">
            ...
            বিকশিত করার জন্য নিরলসভাবে কাজ করে যাচ্ছি।
          </p>
          ...
          <p className="text-justify  leading-relaxed ">
            ...
            নাগরিক হিসেবে গড়ে তোলা। মহান আল্লাহর রহমতে এবং সকলের সহযোগিতায়
            আমাদের এই শিক্ষা প্রতিষ্ঠান আরও এগিয়ে যাবে —এই প্রত্যাশা ব্যক্ত
            করছি।
          </p>

          {/* signature */}
          <p className="text-black font-bold ml-6"> ধন্যবাদান্তে ——</p>
          <p className="font-bold flex items-center gap-2 text-[var(--color-text)] text-2xl">
            <IoCaretForwardOutline />
            <span>আব্দুর রাজ্জাক</span>
          </p>
          <p className="text-gray-600 ml-6">অধ্যক্ষ</p>
          <p className="text-gray-600 ml-6"> রয়েল একাডেমি</p>
          <p className="text-gray-600 ml-6">বেলকুচি, সিরাজগঞ্জ</p>
        </div>
