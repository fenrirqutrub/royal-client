    ...
    >
      ...
      <div className="flex gap-3">
        <button
          onClick={onCancel}
          disabled={isPending}
          className="flex-1 py-2.5 rounded-xl text-sm font-medium bg-gray-100 dark:bg-gray-800
            hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 transition-all disabled:opacity-50"
        >
          বাতিল
        </button>
        <button
          onClick={onConfirm}
          disabled={isPending}
          className="flex-1 py-2.5 rounded-xl text-sm font-semibold bg-rose-500 hover:bg-rose-600
            text-white transition-all flex items-center justify-center gap-2 disabled:opacity-60"
        >
          {isPending ? (
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-5">
          ...
          {config.hasImages && (
            <div>
              ...
              <div
                ...
                className="cursor-pointer border-2 border-dashed border-gray-200 dark:border-gray-700
                  hover:border-violet-400 rounded-xl p-4 flex items-center gap-3 transition-colors group"
              >
                    ...
                    {allPreviews.map((src, i) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="absolute top-1 right-1 w-5 h-5 bg-black/60 hover:bg-rose-500
                            rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all"
                        >
          ...
          <div className="flex gap-3 pt-1 border-t border-gray-100 dark:border-gray-800">
            <button
              ...
              className="sm:w-28 py-2.5 rounded-xl text-sm font-medium bg-gray-100 dark:bg-gray-800
                hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 transition-all disabled:opacity-50"
            >
              বাতিল
            </button>
...
const RecordCard = ({
  ...
  <motion.div
    ...
    initial="hidden"
    animate="visible"
    className="bg-[var(--color-bg)] rounded-2xl border border-[var(--color-gray)] p-5
      hover:shadow-md hover:border-violet-200 dark:hover:border-violet-800 transition-all duration-200 group"
  >
      ...
      <div className="flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
        ...
        <button
          ...
          className="w-8 h-8 rounded-lg flex items-center justify-center
            ...
            text-rose-500 dark:text-rose-400 transition-colors"
        >
    ...
    <p
      className="text-xs text-[var(--color-gray)] line-clamp-2 leading-relaxed
      border-t border-[var(--color-active-border)] pt-3 mb-3"
    >
      {record.topics}
    </p>
...
const ManagementShell = ({ config }: { config: ShellConfig }) => {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg)] py-10">
      ...
      >
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700
              bg-white dark:bg-gray-900 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400
        ...
        <div className="relative sm:w-52">
          <select
            ...
            className="w-full appearance-none pl-4 pr-9 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700
      ...
      {/* Pagination — only for groupKey-based pages */}
      {!config.useDateFilter &&
        !isLoading &&
        !isError &&
        sortedKeys.length > 1 && (
